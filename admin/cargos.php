                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="col-4">
                                        <a href="./crearCargo.php" class="btn btn-info">Agregar cargo<i class=""></a>
                                    </div> <br>
                                            ...
                                            while ($campos = mysqli_fetch_array($consulta)) { ?>
                                                <tr class="table-secundary">
                                                    ...
                                                    <th>
                                                        ...
                                                        <a href="./eliminarCargo.php? id=<?= $campos['idCargo']; ?>" class="btn btn-danger"><i class="fa fa-trash-alt"></i></a>
                                                    </th>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
