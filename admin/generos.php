...
<body class="hold-transition sidebar-mini layout-fixed sidebar-open oss-dragging">
                                ...
                                <div class="modal-body">
                                    <div class="col-sm-12 mb-3">
                                        <div class="card card-top-line">
                                            <h5 class="card-header"><b>Crear Género</b></h5>
                                            <div class="card-body">
                                                    ...
                                                    <form action="" method="post">
                                                        <div class="row mx-auto">
                                                            ...
                                                            <div class="col-sm-3 mb-3" style="margin-left:20px;">
                                                                <input type="text" style=" width: 180px;" class="form-control form-control-sm" id="empresa" name="genero" autofocus required>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="card card-top-line">
                                            <h5 class="card-header"><b>Género</b></h5>
                                            <div class="card-body">

                                                <div class="form-group">
                                                    <form action="editarGenero.php" method="post" id="EditarFormulario">
                                                        ...
                                                        <div class="row mx-auto">
                                                            ...
                                                            <div class="col-sm-3 mb-3" style="margin-left:20px;">
                                                                <input type="text" id="genero" style=" width: 180px;" class="form-control form-control-sm" name="genero" autofocus required>
                        ...
                        <div class="col-sm-8 mb-3">
                            ...
                            <div class="card card-top-line">
                                ...
                                <h3 class="card-header "><button type="button" class="btn button-18" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    ...
                                    </button><b style="margin-left: 150px;">Géneros Registrados</b>
                                            ...
                                            while ($campos = mysqli_fetch_array($consulta)) { ?>
                                                <tr class="table-secundary">
                                                    ...
                                                    <button type="button" class="btn btn-primary-new editbtn" data-bs-toggle="modal" data-bs-target="#editar"><i class="fa-solid fa-pen-to-square"></i></button>
                                                        <button type="button" name="desactivarGenero" class="btn button-18-new desactivarGenero" data-bs-toggle="modal" data-bs-target="#desactivar">
                                ...
                                <div class="modal fade" id="desactivar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog ">
                                        <div class="modal-content ">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel"> Desactivar Género <i class="fa-solid fa-trash-alt"> </i></h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="eliminarGenero.php" method="POST" id="editarFormulario">
    ...
    <script>
     ...
     <script>
        $(".desactivarGenero").click(function() {
            $tr = $(this).closest('tr');
            var datos = $tr.children("td").map(function() {
                return $(this).text();
            });
