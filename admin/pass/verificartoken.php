<?php 
    ...
    $token =$_POST['token'];
    $codigo =$_POST['codigo'];
    $res=$miConexion->query("SELECT * FROM recuperarpass WHERE 
        email='$email' AND token='$token' AND codigo=$codigo")or die($miConexion->error);
    $correcto=false;
...
<body>
    <div class="container">
        <div class="row justify-content-md-center" style="margin-top:15%">
            <?php if($correcto){ ?>
                <form class="col-3" action="./cambiar.php" method="POST">
