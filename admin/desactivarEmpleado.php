                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="./desactivarEmpleado.php" class="nav-link active">
                                ...
                                <div class="card card-body">
                                    <div class="row">
                                        <div class="text-center">
                                            <h1 class="text-center">Desactivar Empleado</h1>
                                        </div>
                                    </div>
                                        ...
                                        <form action="" method="post">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <input type="number" name="identificacion" placeholder="empleado a desactivar" required>
                                                </div>
                                            </div>
                                            <br>
                                            <input type="submit" name="desactivar" class="btn btn-primary" value="Desactivar">
                                        </form>
                                    </div>
                                </div>
                                <!-- /.card-body -->
...
if (isset($_POST['desactivar'])) {
    ...
    $sql = "UPDATE personalasistencial SET estado = 'inactivo'
            WHERE idPersonalAsistencial = $identificacion";
