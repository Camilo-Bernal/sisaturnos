                                        ...
                                        <table id="example2" class="table table-bordered table-striped bdr">
                                            <thead class="thead-init thead-titulo">
                                                ...
                                                <tr class="thead-subtitulo text-center">
                                                    ...
                                                    <th class="col-sm-2">Profesión</th>
                                                    <th class="col-sm-2">Horas Dominicales Diurnas</th>
                                                    <th class="col-sm-2">Horas Festivas Diurnas</th>
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                $consulta = mysqli_query($miConexion, $sql);
                                                $sql1 = "SELECT * FROM recargoscontrato WHERE idContrato ='Planta Permanente' AND idProfesion = '$prof'";
                                                $consulta1 = mysqli_query($miConexion, $sql1);
                                                $sql2 = "SELECT *FROM programacion";
