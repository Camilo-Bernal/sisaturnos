                        ...
                        <div class="col-sm-12 ">
                            ...
                            <div class="card card-top-line mt-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <h3 class="card-header text-center mb-4"><b>Recargos Planta Temporal</b> </h3>
                                    <div class="container">
                                        <br />
                                        ...
                                        <table id="example2" class="table table-bordered table-striped bdr">
                                            <thead class="thead-init thead-titulo">
                                                ...
                                                <tr class="thead-subtitulo text-center">
                                                    ...
                                                    <th class="col-sm-2">Nombres Completos</th>


                                                    <th class="col-sm-2">Nocturnos Ordinadios</th>

                                                    <th class="col-sm-2">Dominicales Diurnas</th>
                                                    <th class="col-sm-2">Dominicales Nocturnos</th>

                                                    <th class="col-sm-2">Festivas Diurnas</th>
                                                    <th class="col-sm-2">Festivas Nocturnos</th>
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                $consulta = mysqli_query($miConexion, $sql);
                                                $sql1 = "SELECT * FROM recargoscontrato WHERE idContrato ='Planta Temporal' AND idProfesion = '$prof'";
                                                ...
                                                ?>
                                                            <tr class="table-secundary">
                                                                ...
                                                                <td><?= $datos['horasNoctOrd']; ?></td>
                                                                <td><?= $datos['horasDiurnDom']; ?></td>
                                                                <td><?= $datos['horasNoctDom']; ?></td>
                                                                <td><?= $datos['horasDiurnFest']; ?></td>
                                                                <td><?= $datos['horasNoctFest']; ?></td>
                                                                <td><?= $datos['totalRecargo']; ?></td>
